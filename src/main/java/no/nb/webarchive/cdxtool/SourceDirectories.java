 ...
 */
public class SourceDirectories {
    ...
    public void addSourceDirectories(SourceDirectory... sourceDirectory) {
        this.sourceDirectories.addAll(Arrays.asList(sourceDirectory));
    }
    
    public void addSourceDirectories(Collection<SourceDirectory> sourceDirectory) {
        this.sourceDirectories.addAll(sourceDirectory);
    }
    
    public void walk(FileVisitor visitor) {
        for (SourceDirectory srcDir : sourceDirectories) {
            srcDir.walk(visitor);
        }
    }
}
